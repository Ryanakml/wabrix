...
const getFileIcon = (fileType: string, fileName: string) => {
  ...
  if (fileType === "application/pdf" || extension === "pdf") {
    return (
      <Icons.fileTypePdf {...iconProps} className="text-red-500 dark:text-red-400" />
    );
  }
  ...
  if (
    ...
    return (
      <Icons.fileTypeDoc {...iconProps} className="text-blue-500 dark:text-blue-400" />
    );
  }
  ...
  if (
    ...
    return (
      <Icons.fileTypeXls {...iconProps} className="text-green-500 dark:text-green-400" />
    );
  }
  ...
  if (
    ["js", "ts", "jsx", "tsx", "py", "java", "c", "cpp", "html", "css"].includes(
      extension,
    ) ||
...
const getFormattedFileType = (fileType: string, fileName: string): string => {
  ...
  return (cleanType ?? "FILE").toUpperCase().substring(0, 8);
};
