    ...
    <div className="border-border/40 bg-background/75 flex flex-col gap-3 rounded-2xl border p-3 backdrop-blur sm:gap-4 sm:rounded-3xl sm:p-4 lg:hidden">
      ...
      <div className="space-y-1.5 sm:space-y-2">
        ...
        <select
          ...
          className="border-border/40 bg-background/70 text-foreground focus:border-primary/40 focus:ring-primary/30 w-full rounded-xl border px-2.5 py-1.5 text-xs focus:outline-none focus:ring-2 sm:rounded-2xl sm:px-3 sm:py-2 sm:text-sm"
        >
