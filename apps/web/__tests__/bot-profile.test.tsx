...
describe("Bot Profile", () => {
  it("saves bot configuration and previews emulator output with live draft config", async () => {
    render(
      <BotProfileClient
        copy={{
          loading: "Loading",
          ...
          apiKey: "API key",
          apiKeyKeepPlaceholder: "Leave blank to keep the current encrypted key",
