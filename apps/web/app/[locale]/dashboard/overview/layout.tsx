...
import { buildOverviewCards } from '@/features/overview/lib/overview-data';
...
export default function OverViewLayout({
  ...
  const cards = buildOverviewCards(analytics);
              ...
              <CardHeader>
                ...
                <CardAction>
                  <Badge variant='outline'>
                    {card.positive ? <Icons.trendingUp /> : <Icons.trendingDown />}
                    {card.trend}
                  </Badge>
                </CardAction>
              </CardHeader>
