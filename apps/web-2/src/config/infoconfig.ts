  ...
  sections: [
    {
      title: 'Overview',
      description:
        "The Billing page shows your workspace subscription, monthly usage, and recent billing events. Billing state is sourced from the application's own subscription, plan, usage counter, and billing event records.",
      links: []
    },
    {
      title: 'Available Plans',
      description:
        'Use the plan catalog on this page to compare AI token, outbound messaging, and seat limits before starting checkout for a different plan.',
      links: []
    },
    {
      title: 'Plan Features',
      description:
        'Each plan carries its own entitlements for AI tokens, outbound messages, and seats. These entitlements are enforced by backend usage checks and monthly counters.',
      links: []
    },
    {
      title: 'Access Control',
      description:
        'Billing operations are scoped to the active organization. The page uses the current workspace context and backend role checks to ensure only authorized members can manage plan state.',
      links: []
    },
    {
      title: 'Checkout Providers',
      description:
        'Checkout provider selection follows billing country. The app currently routes Indonesia through Midtrans and other countries through Polar.',
      links: []
    },
    {
      title: 'Setup Requirements',
      description:
        'Production billing requires the relevant provider credentials and product identifiers to be configured in the environment for the selected checkout gateway.',
      links: []
    }
  ]
};
